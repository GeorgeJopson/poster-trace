...
export default function ParticleButton({children, className, fontSize}) {
  ...
  return (
    <BaseButton className={`${styles.particleBtn} ${className}`} fontSize={fontSize} onMouseEnter={addShimmer}>
      {shimmerIds.map((id) => (
