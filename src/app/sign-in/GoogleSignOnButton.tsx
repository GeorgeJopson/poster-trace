import styles from "./GoogleSignOnButton.module.css";

// Original code comes from https://developers.google.com/identity/branding-guidelines
  ...
  return (
    <button className={styles.gsiMaterialButton} onClick={onClick}>
      ...
      <div className={styles.gsiMaterialButtonContentWrapper}>
        <div
          className={`${styles.gsiMaterialButtonIcon} ${isPending && styles.spin}`}
        >
          <svg
            version="1.1"
